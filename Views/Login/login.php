...
<body class="">
      ...
      <div class="page-header min-vh-100">
        <div class="container">
          <div class="row d-flex justify-content-center">
            <div class="col-12 col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
  ...
  <script src="<?= base_url() ?>/Assets/js/plugins/argon-dashboard.min.js?v=2.0.4"></script>
</body>
