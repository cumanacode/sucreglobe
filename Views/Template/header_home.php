...
<nav class="navbar navbar-expand-lg fixed-top bg-light bg-opacity-30" id="mainNav">
            <div class="container">
                <a class="brand-home" href="#page-top"><img src="<?= base_url(); ?>/Assets/images/logo.png" alt="..." /></a>
